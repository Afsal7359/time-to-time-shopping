...
export default function ProductDetailScreen() {
  ...
  return (
    <>
      {/* ════════════════ MOBILE LAYOUT ════════════════ */}
      <div className="md:hidden h-full flex flex-col relative" style={{ background: C.navy }}>
        <StatusBar light />
        ...
        {/* Image carousel */}
        <div className="relative flex-shrink-0 mx-5 mb-2 rounded-3xl overflow-hidden"
        ...
        {/* Sheet */}
        <div className="flex-1 overflow-y-auto rounded-t-3xl bg-white px-5 pt-5 pb-32 -mt-4 relative z-10">
        ...
        {/* Mobile action bar */}
        <div className="absolute bottom-0 left-0 right-0 bg-white border-t px-5 py-3 flex gap-2 z-20" style={{ borderColor: '#eee' }}>
      ...
      <div className="hidden md:flex flex-1 overflow-hidden">
        ...
        {/* Left: Image panel */}
        <div className="w-[52%] flex-shrink-0 flex flex-col overflow-hidden" style={{ background: C.navyCard }}>
          {/* Panel header */}
        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-white">
          ...
          {/* Sticky action bar */}
          <div className="flex-shrink-0 px-10 py-5 border-t flex gap-3" style={{ borderColor: '#eee', background: '#fff' }}>
            <button onClick={handleWhatsapp}
              className="h-13 px-5 rounded-2xl flex items-center justify-center gap-2 text-sm font-semibold flex-shrink-0"
